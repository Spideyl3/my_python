    ...
    def __call__(self, step, state_dict, metric=None):
        ...
        if self.save_best_only:
            ...
            if metric >= self.best_metrics:
                # save checkpoints
                torch.save(state_dict, os.path.join(self.save_dir, "best1.ckpt"))
                # update best metrics
...
state_dict = torch.load(f"best1.ckpt", map_location="cpu")
...
#
# !cp -r checkpoints/translate-transformer-not-share/best1.ckpt /content/drive/MyDrive/transformer-de-en
